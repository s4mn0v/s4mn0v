...
import { d as defaultOptions, r as resolveColors, b as getDefaultConfig, g as getClientBundleIcons, e as publicComposables, a as addTemplates } from './shared/ui.XkBrgXFP.mjs';
...
const module$1 = defineNuxtModule({
  ...
  async setup(options, nuxt) {
    ...
    nuxt.hook("icon:clientBundleIcons", (icons) => {
      for (const name2 of getClientBundleIcons(nuxt.options.appConfig.ui?.icons)) {
        icons.add(name2);
      }
    });
