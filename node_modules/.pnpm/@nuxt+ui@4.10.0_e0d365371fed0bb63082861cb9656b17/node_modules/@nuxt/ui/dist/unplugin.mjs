...
import { c as getTemplates, e as publicComposables, g as getClientBundleIcons, p as parseIconName, d as defaultOptions, r as resolveColors, b as getDefaultConfig } from './shared/ui.XkBrgXFP.mjs';
...
import { IconUsageScanner, resolveBundleIcons, generateClientBundleCode, collectionNames } from '@nuxt/icon/utils';
...
function parseUserIcon(icon) {
  const parsed = parseIconName(icon, collectionNames, true);
  return parsed ? `${parsed[0]}:${parsed[1]}` : void 0;
}
function IconsPlugin(options, appConfig) {
  ...
  async function generate() {
    ...
    const userIcons = /* @__PURE__ */ new Map();
