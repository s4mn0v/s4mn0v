...
import { RuntimeOptions, ModuleOptions as ModuleOptions$1 } from '@nuxt/icon';
...
interface NuxtUIOptions extends Omit<ModuleOptions, 'fonts' | 'colorMode' | 'content' | 'experimental'> {
    ...
    icon?: Partial<Pick<RuntimeOptions, 'customize' | 'size' | 'mode'>> & {
        clientBundle?: false | Omit<NonNullable<ModuleOptions$1['clientBundle']>, 'includeCustomCollections'>;
    };
    /**
