...
const updateMatchingYChild = (y, yChild, pChild, meta) => {
  if (yChild instanceof Y__namespace.XmlText && pChild instanceof Array) {
  ...
  if (yChild instanceof Y__namespace.XmlElement && !(pChild instanceof Array) && matchNodeName(yChild, pChild)) {
...
const reconcileUnanchoredChildren = (
  ...
  const matchingChildren = math__namespace.min(yEnd - yStart, pEnd - pStart);
...
const reconcileMappedChildren = (y, yDomFragment, pChildren, yChildren, meta) => {
  ...
  if (
    ...
    anchors.some(anchor => {
      ...
      return !(
        (anchor.yChild instanceof Y__namespace.XmlText && pChild instanceof Array) ||
        (anchor.yChild instanceof Y__namespace.XmlElement && !(pChild instanceof Array))
      )
    })
  ) {
    return false
